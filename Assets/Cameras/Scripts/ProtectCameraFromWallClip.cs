...
public class ProtectCameraFromWallClip : MonoBehaviour{
	...
	void LateUpdate() {
		...
		currentDist = Mathf.SmoothDamp(currentDist, targetDist - p.cameraPositionOffset_current, ref moveVelocity, currentDist > targetDist ? clipMoveTime : returnTime );
