...
public class GTA_Weapons_Network{
	...
	public static Weapon_Flags GET_WEAPON_SLOT_FLAGS(WeaponSystemSetupNetwork.Weapon_Slots slot, int id){
		Weapon_Flags TEMP_weapon_flags = new Weapon_Flags();
		switch(slot){
			case(WeaponSystemSetupNetwork.Weapon_Slots.UNARMED):
				TEMP_weapon_flags = new Weapon_Flags(false, false, false);
			break;
		
			case(WeaponSystemSetupNetwork.Weapon_Slots.HANDGUN):
				switch(id){
					case(0):
			...
			case(WeaponSystemSetupNetwork.Weapon_Slots.SUBMACHINEGUN):
				switch(id){
					case(0):
						TEMP_weapon_flags = new Weapon_Flags(true, true, false);
					break;
			...
			case(WeaponSystemSetupNetwork.Weapon_Slots.SHOTGUN):
				switch(id){
					case(0):
			...
			case(WeaponSystemSetupNetwork.Weapon_Slots.RIFLE):
				switch(id){
					case(0):
						TEMP_weapon_flags = new Weapon_Flags(true, true, true);
					break;
			...
			case(WeaponSystemSetupNetwork.Weapon_Slots.HEAVY):
				switch(id){
					case(0):
						TEMP_weapon_flags = new Weapon_Flags(true, true, true);
					break;
	...
	public static Weapon_Motion_Data GET_WEAPON_MOTION_DATA(WeaponSystemSetupNetwork.Weapon_Slots slot, int id){
	...
	public static Weapon_Info GET_WEAPON_INFO(WeaponSystemSetupNetwork.Weapon_Slots slot, int id){
		...
		switch(slot){
			...
			case(WeaponSystemSetupNetwork.Weapon_Slots.HANDGUN):
				switch(id){
					case(0):
						TEMP_weapon_info = new Weapon_Info("Glock 18",Weapon_Attack_Type.RAYCAST, 0.275f, 1.7f, 0.017f, 12, 480, Load_WeaponGO("Glock18"), Load_Icon("Glock 18"), Load_Reticule("Handgun Aim"), Load_Reticule("Handgun Aim Enemy"), Load_Reticule("Enemy Death"), Load_Reticule("Aim Ragdoll"), Load_Reticule("Aim"), Load_Reticule("Aim Enemy"));
					break;
					default:
        				Utils.CLog("[GET_WEAPON_INFO]", "ERROR! Wrong weapon id.", "red");
					break;
			...
			case(WeaponSystemSetupNetwork.Weapon_Slots.SUBMACHINEGUN):
				switch(id){
					case(0):
						TEMP_weapon_info = new Weapon_Info("Micro-Uzi",Weapon_Attack_Type.RAYCAST, 0.11f, 1.6f, 0.025f, 30, 1200, Load_WeaponGO("Uzi"), Load_Icon("Micro-Uzi"), Load_Reticule("Submachinegun Aim"), Load_Reticule("Submachinegun Aim Enemy"), Load_Reticule("Enemy Death"), Load_Reticule("Aim Ragdoll"), Load_Reticule("Aim"), Load_Reticule("Aim Enemy"));
					break;
					default:
						Utils.CLog("[GET_WEAPON_INFO]", "ERROR! Wrong weapon id.", "red");
					break;
			...
			case(WeaponSystemSetupNetwork.Weapon_Slots.SHOTGUN):
				switch(id){
					case(0):
						TEMP_weapon_info = new Weapon_Info("Remington",Weapon_Attack_Type.RAYCAST, 0.315f, 2.5f, 0.03f, 8, 640, Load_WeaponGO("PumpSG"), Load_Icon("PumpShotgun"), Load_Reticule("Shotgun Aim"), Load_Reticule("Shotgun Aim Enemy"), Load_Reticule("Enemy Death"), Load_Reticule("Aim Ragdoll"), Load_Reticule("Aim"), Load_Reticule("Aim Enemy"));
					break;
					case(1):
				TEMP_weapon_info = new Weapon_Info("Dao-12",Weapon_Attack_Type.RAYCAST, 0.3f, 3.5f, 0.03f, 6, 600, Load_WeaponGO("Dao12"), Load_Icon("Dao-12"), Load_Reticule("Shotgun Aim"), Load_Reticule("Shotgun Aim Enemy"), Load_Reticule("Enemy Death"), Load_Reticule("Aim Ragdoll"), Load_Reticule("Aim"), Load_Reticule("Aim Enemy"));
					break;
					default:
        				Utils.CLog("[GET_WEAPON_INFO]", "ERROR! Wrong weapon id.", "red");
					break;
			...
			case(WeaponSystemSetupNetwork.Weapon_Slots.RIFLE):
				switch(id){
					case(0):
						TEMP_weapon_info = new Weapon_Info("M4A1",Weapon_Attack_Type.RAYCAST, 0.135f, 2.5f, 0.013f, 30, 1200, Load_WeaponGO("M4A1"), Load_Icon("M4A1"), Load_Reticule("Rifle Aim"), Load_Reticule("Rifle Aim Enemy"), Load_Reticule("Enemy Death"), Load_Reticule("Aim Ragdoll"), Load_Reticule("Aim"), Load_Reticule("Aim Enemy"));
					break;
					case(1):
						TEMP_weapon_info = new Weapon_Info("AK-47",Weapon_Attack_Type.RAYCAST, 0.135f, 2.5f, 0.013f, 30, 1200, Load_WeaponGO("AK47"), Load_Icon("AK-47"), Load_Reticule("Rifle Aim"), Load_Reticule("Rifle Aim Enemy"), Load_Reticule("Enemy Death"), Load_Reticule("Aim Ragdoll"), Load_Reticule("Aim"), Load_Reticule("Aim Enemy"));
					break;
					default:
        				Utils.CLog("[GET_WEAPON_INFO]", "ERROR! Wrong weapon id.", "red");
					break;
